...
urlpatterns = [
    ...
    path('call_register/', include('call_register.urls')),
    path('calls_uploader', include('calls_uploader.urls')),
    path('productsfinder/', include('productsfinder.urls')),
    path('supervisorsfinder/', include('supervisorsfinder.urls')),
    path('runbizproc/', include("runbizproc.urls")),
    path('downloadasexcel/', include('downloadasexcel.urls')),
    path('import_data/', include('import_data.urls')),
    path('bestcallmanager/', include('bestcallmanager.urls')),
    path('sort_companies/', include('sort_companies.urls')),
    path('convert_an_audio_to_text/', include('convert_an_audio_to_text.urls')),
    path('upload_call_in_telegram/', include('upload_call_in_telegram.urls')),
    path('download_deals/', include('download_deals.urls')),
    path('robot_weather_app/', include('robot_weather_app.urls', namespace='bitrix_robot_weather')),
    path('download_companies_in_db/', include('download_companies_in_db.urls')),
    path('move_deadline_app/', include('move_deadline_app.urls')),
    path('select_user/', include('select_user.urls')),
    path('yandex_map/', include('yandex_map.urls')),
