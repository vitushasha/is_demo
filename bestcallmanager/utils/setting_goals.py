...
from bestcallmanager.utils.table_creation import add_row, add_row_to_df
from bestcallmanager.utils.api_methods import add_task
from bestcallmanager.utils.datetime_utils import parse_date_in_dmy
from usermanager.utils.search_manager import search_manager
import pandas as pd


def setting_goals(but, calls, user_id):
    ...
    if user_id:
        user_dict = {user_id: user_dict[user_id]}
